...
if [ "$TRAVIS_PULL_REQUEST" != "false" -o "$TRAVIS_BRANCH" != "$SOURCE_BRANCH" -o "$NODE_VERSION" == "7" ]; then
...
echo openssl enc -aes-256-cbc -d -in ../deploy_key.enc -out deploy_key -k $ENCRYPTED_KEY
